...
<!--    <link rel="stylesheet" href="./webroot/css/steller.css">-->
    <?= $this->Html->css("steller.css"); ?>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" data-spy="affix" data-offset-top="0">
    <div class="container">
        <a class="navbar-brand" href="#"><?= $this->Html->image("logo.svg",['class' => '']);?></a>
...
<section id="about" class="section mt-3">
    <div class="container mt-5">
        <div class="row text-center text-md-left">
            <div class="col-md-3">
               <?= $this->Html->image("avatar.jpg",['class' => 'img-thumbnail mb-4']);?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="img-wrapper">
                    <?= $this->Html->image("folio-1.jpg",['class' => '']);?>
                    <div class="overlay">
...
<!--                    <img src="assets/imgs/folio-2.jpg" alt="">-->
                    <?= $this->Html->image("folio-2.jpg",['class' => '']);?>
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
...
<!--                    <img src="assets/imgs/folio-3.jpg" alt="">-->
                    <?= $this->Html->image("folio-3.jpg",['class' => '']);?>
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
...
<!--                    <img src="assets/imgs/folio-4.jpg" alt="">-->
                    <?= $this->Html->image("folio-4.jpg",['class' => '']);?>
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
...
<!--                    <img src="assets/imgs/folio-5.jpg" alt="">-->
                    <?= $this->Html->image("folio-5.jpg",['class' => '']);?>
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
...
<!--                    <img src="assets/imgs/folio-6.jpg" alt="">-->
                    <?= $this->Html->image("folio-6.jpg",['class' => '']);?>
                    <div class="overlay">
                        <div class="overlay-infos">
                            <h5>Project Title</h5>
                            <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
...
<!--                            <img src="assets/imgs/avatar-1.jpg" alt="">-->
                            <?= $this->Html->image("avatar-1.jpg",['class' => '']);?>
...
<!--                            <img src="assets/imgs/avatar-2.jpg" alt="">-->
                            <?= $this->Html->image("avatar-2.jpg",['class' => '']);?>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam nostrum voluptates in enim vel amet?</p>
...
<!--                            <img src="assets/imgs/avatar-3.jpg" alt="">-->
                            <?= $this->Html->image("avatar-3.jpg",['class' => '']);?>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam nostrum voluptates in enim vel amet?</p>
...
<!--                    <img src="assets/imgs/blog-1.jpg" alt="" class="card-img-top w-100">-->
                    <?= $this->Html->image("blog-1.jpg",['class' => 'card-img-top w-10']);?>
                    <div class="card-body">
...
<!--                    <img src="assets/imgs/blog-2.jpg" alt="" class="card-img-top w-100">-->
                    <?= $this->Html->image("blog-2.jpg",['class' => 'card-img-top w-10']);?>
                    <div class="card-body">
...
<!--                    <img src="assets/imgs/blog-3.jpg" alt="" class="card-img-top w-100">-->
                    <?= $this->Html->image("blog-3.jpg",['class' => 'card-img-top w-10']);?>
                    <div class="card-body">
...
<?= $this->Html->script('bootstrap.affix.js');?>
<!-- steller js -->
<!--<script src="assets/js/steller.js"></script>-->
<?= $this->Html->script("steller.js") ?>
